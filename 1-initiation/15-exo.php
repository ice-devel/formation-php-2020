<?php
    ...
    * Un pour le nom, un autre pour le pays (liste déroulante)
    * Le formulaire doit être soumis en POST.
    * Quand on recharge la page à la validation du formulaire,
    * les champs doivent être pré-remplis avec les valeurs envoyées
